...
void setup() {
    ...
    // Title
    chinScreen_text("Temperature Monitor", 10, 10, "white", "large");
    
    // Temperature display circle
    temp_circle = chinScreen_circle("red", "white", 60, "top", "center");
    ...
    // Control buttons
    chinScreen_button("green", "white", 100, 40, "Refresh", update_temp, "bottom", "center");
}
