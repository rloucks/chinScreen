...
/* ---- Backlight brightness using LEDC ---- */
                          ...
                          esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    ESP_LOGI(TAG, "Install LCD driver axs15231b");
                                        ...
                                        uint8_t max_point_num)
{
    ...
    /* No rotation correction here.
       Use lv_disp_set_rotation() instead of manipulating raw touch coords. */
    (void)tp;
    (void)x;
    (void)y;
    (void)point_num;
